...
import { Eye, EyeOff, Github, Mail, AlertCircle, Sparkles } from 'lucide-react';
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className={`h-11 pr-10 ${validation.password.message && !validation.password.isValid ? 'border-red-500' : ''}`}
                  disabled={isLoading}
